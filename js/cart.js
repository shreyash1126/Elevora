  ...
  if (cart.length === 0) {
    drawerItems.innerHTML = `
      <div class="empty-mini-cart" style="text-align: center; padding: 40px 0; color: var(--text-muted);">
        ...
        <a href="shop.html" class="btn btn-secondary" style="margin-top: 20px; font-size: 0.8rem; padding: 10px 18px;" onclick="closeMiniCartDrawer()">Shop Now</a>
      </div>
    `;
      ...
      html += `
        <div class="cart-drawer-item">
          ...
          <div class="cart-item-info">
            <h5 class="cart-item-name"><a href="product.html?id=${p.id}">${p.name}</a></h5>
...
// Render cart details on full cart.html layout
  ...
  if (cart.length === 0) {
    itemsContainer.innerHTML = `
      <div style="text-align: center; padding: 60px 24px; border: 1px dashed var(--border-color); border-radius: var(--border-radius-lg);">
        ...
        <a href="shop.html" class="btn btn-primary" style="display: inline-flex; width: auto;">Browse Products</a>
      </div>
    `;
      ...
      html += `
        <div class="cart-row" style="display: grid; grid-template-columns: 3fr 1fr 1fr 1fr; align-items: center; padding: 24px 0; border-bottom: 1px solid var(--border-color);">
          <div class="cart-cell product-cell" style="display: flex; gap: 16px; align-items: center;">
            ...
            <div>
              <h4 style="font-size: 0.95rem; font-weight: 600; margin-bottom: 4px;"><a href="product.html?id=${p.id}">${p.name}</a></h4>
