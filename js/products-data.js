// js/products-data.js
// Exposes the core product dataset and helper methods to query and filter catalog.

const fallbackProducts = [
  {
    "id": 1,
    "name": "AeroPulse ANC Wireless Headphones",
    "category": "Audio Section",
    "brand": "AeroPulse",
    "price": 199.99,
    "oldPrice": 299.99,
    "rating": 4.8,
  ...
  {
    "id": 9,
    "name": "FlexiPlug Rotating Power Hub",
    "category": "Accessories",
    "brand": "VoltMax",
    "price": 14.99,
    "oldPrice": 24.99,
    ...
    "badge": "Best Seller",
    "badgeType": "best",
    "description": "Charge smarter with less clutter and more flexibility. FlexiPlug turns a single wall socket into a 3-in-1 rotating power solution, letting you charge multiple devices at once without messy extension cords.",
    "images": [
      "https://images.unsplash.com/photo-1618220179428-22790b461013?w=600&auto=format&fit=crop&q=80",
      "https://images.unsplash.com/photo-1622445262465-2481c4574875?w=600&auto=format&fit=crop&q=80",
      "https://images.unsplash.com/photo-1583863788434-e58a36330cf0?w=600&auto=format&fit=crop&q=80"
    ...
    "specs": {
      ...
      "Rotation": "180 Degree Rotating Head",
    ...
    "features": [
      ...
      "180 Degree Rotating Head - Adjusts easily to fit tight spaces and behind furniture",
...
// Fetch active products from backend or local fallback
...
// Return related products based on category match
...
async function getBrands() {
  const list = await getProducts();
  const brands = list.map(p => p.brand);
